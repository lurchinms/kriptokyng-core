...
"""Verify that starting kriptoyng with -h works as expected."""
import subprocess

from test_framework.test_framework import kriptoyngTestFramework
from test_framework.util import assert_equal

class HelpTest(kriptoyngTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kriptoyng with -h for help text")
        ...
        self.log.info("Start kriptoyng with -version for version information")
