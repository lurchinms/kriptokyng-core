...
By default, kriptoyngd will dump mempool on shutdown and
...
class MempoolPersistTest(kriptoyngTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give kriptoyngd a second to reload the mempool
        ...
        self.log.debug("Prevent kriptoyngd from writing mempool.dat to disk. Verify that `savemempool` fails")
