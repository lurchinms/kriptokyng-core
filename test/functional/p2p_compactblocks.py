...
# TestNode: A peer we use to send messages to kriptoyngd, and store responses.
...
class CompactBlocksTest(kriptoyngTestFramework):
    ...
    # This test actually causes kriptoyngd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kriptoyngd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kriptoyngd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kriptoyngd will not send blocktxn responses for blocks whose height is
