...
#ifndef kriptoyng_WALLET_WALLET_H
#define kriptoyng_WALLET_WALLET_H
...
public:
     ...
     * on this kriptoyng node, and set to 0 for transactions that were created
...
#endif // kriptoyng_WALLET_WALLET_H
