    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return kriptoyngUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, kriptoyngUnits::separatorNever);
            else
                return kriptoyngUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+kriptoyngUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
