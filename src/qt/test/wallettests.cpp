...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<kriptoyngAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_kriptoyng-qt -platform xcb      # Linux
//     src/qt/test/test_kriptoyng-qt -platform windows  # Windows
//     src/qt/test/test_kriptoyng-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = kriptoyngUnits::formatWithUnit(unit, balance, false, kriptoyngUnits::separatorAlways);
    ...
    // Amount input
    kriptoyngAmountField* amountInput = receiveCoinsDialog.findChild<kriptoyngAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: kriptoyng:")) != -1);
