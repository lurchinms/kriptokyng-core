...
#ifndef kriptoyng_TEST_SCRIPTNUM10_H
#define kriptoyng_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from kriptoyng 0.10.0, for cross-comparison.
 */
public:
