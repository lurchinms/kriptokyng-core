...
#ifndef kriptoyng_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define kriptoyng_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // kriptoyng_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
